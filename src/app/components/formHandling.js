...
//                         setResponseMessage(`Success! Ypour post ID is: ${data.id}`);
...
//                     setShouldSubmit(false); //Reset to prebent multiple submissions
//                 }
//             }
//         };
...
//                     required
//                     className="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indio-500"/>
//                 </div>
...
//                     onChange={handleChange}
//                     required
//                     className="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo"/>
//                 </div>
